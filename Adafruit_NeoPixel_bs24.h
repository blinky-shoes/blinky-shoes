...
#ifndef ADAFRUIT_NEOPIXEL_BS24_H
#define ADAFRUIT_NEOPIXEL_BS24_H
...
class Adafruit_NeoPixel_bs24 {

 public:

  // Constructor: number of LEDs, pin number, LED type
  Adafruit_NeoPixel_bs24(uint16_t n, uint8_t p=6, uint8_t t=NEO_GRB + NEO_KHZ800);
  ~Adafruit_NeoPixel_bs24();
...
#endif // ADAFRUIT_NEOPIXEL_BS24_H
